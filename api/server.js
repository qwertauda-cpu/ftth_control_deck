...
// ==================== Local Tickets API Routes - REMOVED ====================
// تم حذف جميع endpoints التذاكر المحلية (/api/tickets GET, POST, PUT)
// النظام الآن يجلب التذاكر فقط من موقع الوطني عبر /api/alwatani-login/:id/support/tickets
